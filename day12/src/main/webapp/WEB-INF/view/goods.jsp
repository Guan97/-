...
<body class="gray-bg">
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="modal_goods_edit" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_goods" method="post" action="reserveGoods.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>学生性别：</td>
								<td>
									<input type="radio" name="gsex" value="男">男
									<input type="radio" name="gsex" value="女">女
								</td>
							</tr>
							<tr>
								<td>学生爱好：</td>
								<td>
									<input type="checkbox" name="ghobby" value="篮球">篮球
									<input type="checkbox" name="ghobby" value="足球">足球
									<input type="checkbox" name="ghobby" value="排球">排球
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>学生状态：</td>
								<td>
							...
							<tr>
								<td>入学时间：</td>
								<td><input type="date" id="gbirthday" name="gbirthday"
									class="form-control" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>社区：</td>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_goods_btn">保存</button>
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="modal_type_edit" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
	...
	<!--删除对话框 -->
	<div class="modal fade" id="modal_goods_del" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
				<button type="button" class="btn btn-danger"  id="del_goods_btn">刪除</button>
	...
	$(function () {
	    ...
	    var validator = $("#form_goods").validate({
	    ...
	    var validator2 = $("#form_type").validate({
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	dataType:"json",
   		    	success: function (data) {
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_add").click(function(){
	    		...
	    		$('#modal_goods_edit').modal({backdrop: 'static', keyboard: false});
				$('#modal_goods_edit').modal('show');
	        });
	    	...
	    	$("#btn_del").click(function(){
	    		...
	    		if(getSelections && getSelections.length>0){
	    			$('#modal_goods_del').modal({backdrop: 'static', keyboard: false});
	    			$("#modal_goods_del").show();
	    		}else{
	...
	function initEditUser(getSelection){
		...
		$('#gname').val(getSelection.gname);
		$("input[value='"+getSelection.gsex+"']").prop("checked","checked");
		var h = getSelection.ghobby.split(",");
		for (var i = 0; i < h.length; i++) {
			$("input[value='"+h[i]+"']").prop("checked","checked");
		}
		$("#start").val(getSelection.start);
		$("#gbirthday").val(new Date(getSelection.gbirthday).Format("yyyy-MM-dd"));
