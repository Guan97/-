...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="did" id = "txt_search_did">
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="modal_emps_edit" role="dialog" aria-labelledby="modal_emps_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_adds" method="post" action="reserveEmp.htm" >
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_emps_btn">保存</button>
	...
	$(function () {
	    ...
	    $("#submit_form_emps_btn").click(function(){
	    	$("#form_adds").submit();
	    });
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_add").click(function(){
	    		...
	    		$('#modal_emps_edit').modal({backdrop: 'static', keyboard: false});
				$('#modal_emps_edit').modal('show');
	        });
	...
	function initEditUser(getSelection){
		...
		$('#txt_search_did').val(getSelection.did); */
	}
