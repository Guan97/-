        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">人员名 </span>
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="date" name="beginDate"  id="txt_search_beginDate" >
			      <input type="date" name="endDate"  id="txt_search_endDate" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>特点：</td>
								<td><input type="text" id="trait" name="trait"
									class="form-control" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>入职日期：</td>
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            beginDate: $("#txt_search_beginDate").val(),
	    		...
	    		$.ajax({
	    		    ...
	    		    success:function(res){
	    		    	if(res.success){
	    		    		var xary=new Array();
	    		    		var yary=new Array();
	    		    		res.data.forEach(function(personVo){//  饼图 数据处理
